...
public class StringUtils {
	...
	public static final String QUERY_REGISTER_USER = "INSERT INTO users ("
			+ "username, firstname, lastname, email, phonenumber, gender, password, role) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

	public static final String QUERY_LOGIN_USER_CHECK = "SELECT * FROM users WHERE user_name = ?";
	// End: Queries

	
	public static final String JKASHDK = "SELECT id FROM users WHERE user_name = ?";
	...
	//add products admin
	public static final String QUERY_REGISTER_PRODUCT = "INSERT INTO products ("
            + "productName, description, category, price,stocklevel,path)"
            + "VALUES (?,?,?,?,?,?)";
	...
	//getting all products for index page
    public static final String QUERY_GET_ALL_PRODUCTS = "SELECT * FROM products";
    
    public static final String QUERY_PRODUCT_DETAILS = "SELECT * FROM products WHERE name = ?";
