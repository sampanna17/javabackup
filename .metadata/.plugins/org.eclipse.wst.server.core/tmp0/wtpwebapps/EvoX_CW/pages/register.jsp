    ...
    <div class="container">
        ...
        <form action="<%=contextPath%>/registeruser" method="post">
               ...
               <div class="input-name">
                    ...
                    <span>
                        <i class="fa fa-user lock"></i>
                        <input type="text" placeholder="Last Name" class="name" name="laststname">
                    </span>
                ...
                <div class="input-name">
                    ...
                    <input type="text" placeholder="PhoneNumber" class="text-name" name="phonenumber">
                </div>
                <div class="input-name">
                ...
                <div class="input-name">
                    <label for="gender" style="display: inline-block; margin-right: 10px;">Gender :</label>
     				 
                    <input type="radio" class="radio" name="gender" style="display: inline-block;">
                    <label style="margin-right: 20px; display: inline-block;">Male</label>

                    <input type="radio" class="radio1" name="gender" style="display: inline-block;">
